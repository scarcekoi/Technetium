...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreFeatureConfig.Target> overworldTechnetiumOres =
                List.of(OreFeatureConfig.createTarget(stoneReplacables, ModBlocks.TECHNETIUM_ORE.getDefaultState()),
                        OreFeatureConfig.createTarget(deepslateReplacables, ModBlocks.DEEPSLATE_TECHNETIUM_ORE.getDefaultState()));
