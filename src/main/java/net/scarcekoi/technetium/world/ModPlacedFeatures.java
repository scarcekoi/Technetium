...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context, TECHNETIUM_ORE_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(ModConfiguredFeatures.TECHNETIUM_ORE_KEY),
                ModOrePlacement.modifiersWithCount(65, // Veins per Chunk
